  ...
  mensajes.forEach((m) => {
    ...
    btnRechazar.addEventListener('click', async () => {
      ...
      const avisoTexto = m.accion_drapp
        ? `El turno ya ${ACCION_DRAPP_VERBO_OP[m.accion_drapp] || 'se modificó'} en DrApp -- rechazar esto NO lo deshace, solo evita que el paciente reciba este mensaje.`
