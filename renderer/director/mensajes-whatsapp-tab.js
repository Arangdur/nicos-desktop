  ...
  el.innerHTML = `
    <div class="card">
      ...
      <p class="help-text">
        ...
        respuesta, vos lo revisás (editable) y recién ahí se manda. Excepciones que se
        mandan directo, para que la respuesta sea rápida: un saludo puro ("hola", "buen día"),
        el acuse de un pedido de receta ("recibimos tu pedido, ya lo derivamos"), y un mensaje
        de seguimiento sobre esa misma receta (ahí la IA contesta libre y se manda sola — la
        única excepción real a que la IA solo redacte). La receta en sí sigue gestionándose
        como siempre, esto no la emite ni la aprueba. Cualquier otra cosa (turno, urgencia,
        primer contacto por algo clínico) siempre espera tu aprobación.
      </p>
    </div>
